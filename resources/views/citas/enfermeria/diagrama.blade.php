...
<head>
    ...
    <title>Diagrama Enfermeria</title>
</head>
<body>
<br>
...
<div class="container">
    ...
    <table>
        ...
        <tr>
            @foreach($enf as $e)
                <td style="border:0.5px solid; padding: 1px">{{$e->user->name}} {{$e->user->last_name}}: {{$e->cod_diagrama}}</td>
            @endforeach
        </tr>
    </table>
    <hr>
    ...
    <div class="row">
        ...
        <div class="col-sm">
            ...
            <select name="episodio">
                <option>Seleccione Paciente Activo</option>
        ...
        <div class="col-sm">
            ...
            <br>
            <select name="turno">
                <option value="1" @if($turno=='1') selected @endif>Mañana</option>
                <option value="2" @if($turno=='2') selected @endif >Tarde</option>
                <option value="24" @if($turno=='24') selected @endif >24</option>
            </select>
...
@if(isset($mes) && isset($anio) && isset($epi) && isset($turno))

    @include('citas.enfermeria.tabla_enf2',['mes'=>$mes,'anio'=>$anio,'ep'=>$epi])
@endif
...
<script src="/js/diagramas/enfermeria/cargamasiva.js"></script>
