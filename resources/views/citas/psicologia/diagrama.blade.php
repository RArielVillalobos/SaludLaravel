...
<head>
    ...
    <title>Diagrama Psicologia</title>
</head>
<body>
<br>
        ...
        <tr>
            @foreach($psicologos as $psicologo)
                @if($psicologo->user->status->id==1)
                    <td style="border:0.5px solid; padding: 1px; margin: 1px; font-size: 10px;">{{$psicologo->user->last_name}} {{$psicologo->user->name}}: <strong style="font-size: 12px">{{strtoupper($psicologo->cod_diagrama)}}</strong> </td>
                @endif
            @endforeach
        </tr>
    </table>
...
@if(isset($mes) && isset($anio) && isset($epi))
    ...
    @include('citas.psicologia.tabla_psi',['mes'=>$mes,'anio'=>$anio,'ep'=>$epi])
@endif

<script src="https://code.jquery.com/jquery-3.2.1.slim.min.js" integrity="sha384-KJ3o2DKtIkvYIK3UENzmM7KCkRr/rE9/Qpg6aAZGJwFDMVNA/GpGFF93hXpG5KkN" crossorigin="anonymous"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.12.9/umd/popper.min.js" integrity="sha384-ApNbgh9B+Y1QKtv3Rn7W3mgPxhU9K/ScQsAP7hUibX39j7fakFPskvXusvfa0b4Q" crossorigin="anonymous"></script>
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/js/bootstrap.min.js" integrity="sha384-JZR6Spejh4U02d8jOt6vLEHfe/JQGiRRSQQxSfFWpi1MquVdAyjUar5+76PVCmYl" crossorigin="anonymous"></script>
<script src="/js/diagramas/psicologia/main.js"></script>
